<?php
namespace Perspective\BlogManager\Block\Adminhtml\Blog\Edit\Tab;
...
class RelatedProducts extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function __construct(
        ...
        \Perspective\BlogManager\Model\Blog\Status $blogStatus,
    ...
    {
        $collection = $this->_productCollectionFactory->create()->addAttributeToSelect('name');
        $products = [];
