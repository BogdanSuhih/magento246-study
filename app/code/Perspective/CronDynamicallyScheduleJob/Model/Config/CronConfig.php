<?php
namespace Perspective\CronDynamicallyScheduleJob\Model\Config;

class CronConfig extends \Magento\Framework\App\Config\Value
{

    const CRON_STRING_PATH = 'crontab/default/jobs/perspective_dynamically_schedule_cron_job/schedule/cron_expr';
 
    const CRON_MODEL_PATH = 'crontab/default/jobs/perspective_dynamically_schedule_cron_job/run/model';
